...
const EliminarRequisitos: FC<RequisitosProps> = ({
 pathEnable,
 pathDisable,
 title,
}) => {
  ...
  return (
    <div>
      {!isLoading ? (
        <>
          <PageTitle>Lista de Requisitos - {title}</PageTitle>
...
export default EliminarRequisitos;