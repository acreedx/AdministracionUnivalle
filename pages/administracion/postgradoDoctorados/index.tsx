...
function Maestria() {
  ...
  const [dataTable, setTotalData] = useState<IDoctorados[]>([]);
  const [dataTable2, setUserInfo] = useState<IDoctorados[]>([]);
  const [dataTableSearch, setSearch] = useState<IDoctorados[]>([]);
    ...
    <Layout>
      {!isLoading ? (
        <>
          ...
          <div className="mb-8">
            <Link href="/administracion/postgradoDoctorados/addDoctorado/">
                              ...
                              <div className="flex items-center space-x-4">
                                {datos.estado && (
                                  <>
                                    <Link
                                      href={{
                                        pathname: `/administracion/postgradoDoctorados/editDoctorado/${datos.id}`,
                                      }}
                                    >
                                      <Button
                                        layout="link"
