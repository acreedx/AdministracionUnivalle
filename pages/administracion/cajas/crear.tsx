    ...
    <Layout>
      ...
      <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <Label>
          ...
          <Input className="mt-1" placeholder='Ingresa el nombre del servicio'/>
        </Label>
        <Label className="mt-4">
          <span>Ubicación</span>
          <Input className="mt-1" placeholder='Ingresa la ubicación del servicio'/>
        </Label>
        <Label className="mt-4">
          <span>Encargado</span>
          <Input className="mt-1" placeholder='Ingresa el encargado del servicio'/>
        </Label>
        <Label className="mt-4">
          <span>Teléfono de referencia</span>
          <Input className="mt-1" placeholder='Ingresa el teléfono de referencia'/>
        </Label>
        <Label className="mt-4">
