...
function BienestarUniversitario() {
  ...
  useEffect(() => {
    setIsLoading(true);
    getData(
      "http://apisistemaunivalle.somee.com/api/Servicios/getServicioByModuloId/15"
    );
  ...
  const handleActiveChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (e.target.value === "activos") {
      ...
      getData(
        "http://apisistemaunivalle.somee.com/api/Servicios/getDisabledServicioByModuloId/15"
      );
    }
  };
