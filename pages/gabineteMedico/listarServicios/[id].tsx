...
function GabineteMedico() {
 ...
 useEffect(() => {
    const getData = async () => {
      const query = await fetch(`http://apisistemaunivalle.somee.com/api/Servicios/getServicioByModuloId/15`);
              ...
              <TableRow key={datos}>
                ...
                <TableCell>
                  <div className="flex items-center space-x-4">
                    <Link href={{pathname: `/gabineteMedico/editar/${datos.identificador}`}}>
