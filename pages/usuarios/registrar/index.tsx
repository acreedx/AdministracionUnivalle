...
import { IRegistrarUsuario,IListarCargos,IListarUsuario } from "../../../utils/interfaces/usuarios";
import {
  Input,
  Label,
  HelperText,
...
const handleChange1 = (e: ChangeEvent<HTMLInputElement>, campo: string) => {
    ...
    usuariosData.map((data:any)=>{
      data.ci===usuarioData.ciUsuario? setValid(false) : data.ci!==usuarioData.ciUsuario? setValid(true): setValid(null)
      ...
      <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
          ...
          <div >
            <Label className=" mb-2">
              ...
              {
                ciValid === true ? (
                  <HelperText valid={ciValid}>Es un carnet de identidad válido</HelperText>
                ) : ciValid === false ? (
                  <HelperText valid={ciValid}>Este carnet de identidad ya existe</HelperText>
                ) : (
            ...
            <Label className=" mb-2">
              ...
              <Select className="mt-1">
                ...
                cargosData.map((datos:any,i)=>(
                  <option key={i} value={datos.id}>{datos.nombrecargo}</option>
                  ))
                } 
              </Select>
            </Label>
